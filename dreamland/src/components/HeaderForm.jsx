...
// import { nanoid } from "nanoid"; // Benzersiz ID için
...
//             const reader = new FileReader();
//             reader.onloadend = () => {
//                 setImageUrl(reader.result); // Resmi hemen göster
//             };
//             reader.readAsDataURL(selectedFile);
//         }
//     };
...
//         // Formu hemen resetle
//         const tempFormData = { ...formData }; // Veriyi geçici olarak sakla
//         setFormData({
//             name: "",
//             imageUrl: "",
//             title: "",
...
//                         {/* <img src={formData.imageUrl || "https://dummyimage.com/600x500/ccc/aaa"} className="object-cover" />
//                         {imageUrl && <img src={imageUrl} alt="Preview" style={{ maxWidth: "200px", marginTop: "10px" }} />} */}
//                         <img src={imageUrl || "https://dummyimage.com/600x500/ccc/aaa"} className="object-cover h-full w-full rounded-lg" alt="Preview"
//             />
//                     </div>
//                     <div className="flex justify-center">
//                         <input type="file" className="mt-1 p-1 w-[6.5rem] border rounded-lg text-gray-800 outline-none text-sm cursor-pointer" onChange={handleFileChange} accept="image/*"/>
//                     </div>
//                 </div>
//                 <div className="w-2/3 py-4 border">
    ...
    return (
        ...
        <div className="flex">
            ...
            <div className="flex justify-start">
                <input type="file"
                className="mt-1 p-1 w-40 border rounded-lg text-gray-800 outline-none text-sm cursor-pointer" onChange={handleFileChange} accept="image/*"  />
            </div>
            </div>
